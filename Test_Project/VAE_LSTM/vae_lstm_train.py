...
def predict_random_samples_with_debugging(vae, lstm_predictor, test_loader, num_samples=5):
    ...
    def denormalize(numbers):
        main_numbers = (numbers[:5] * 70).astype(int).tolist()  # Main numbers (scaled back to 1-70)
        mega_ball = int(numbers[5] * 25)  # Mega Ball (scaled back to 1-25)
...
# Call the function to predict and debug 5 random samples
predict_random_samples_with_debugging(vae, lstm_predictor, test_loader, num_samples=1)
